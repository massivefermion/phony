...
pub const by_alpha2 = [
  ...
  #(
    "GT",
    #("Guatemala", "502", "[3-5]\\d{7}", "[267][2-9]\\d{6}", [8], option.None),
  ),
  #(
    "GU",
    #(
  ...
  #("NU", #("Niue", "683", "888[4-9]\\d{3}", "[47]\\d{3}", [4, 7], option.None)),
  #(
    "NZ",
    #(
      "New Zealand",
  ...
  #(
    "SC",
    #("Seychelles", "248", "2[125-8]\\d{5}", "4[2-46]\\d{5}", [7], option.None),
  ),
  #(
    "SD",
    #(
  ...
  #(
    "SZ",
    #("Eswatini", "268", "7[6-9]\\d{6}", "[23][2-5]\\d{6}", [8], option.None),
  ),
  #(
    "TC",
    #(
...
pub const by_code = [
  ...
  #(
    "253",
    #("Djibouti", "DJ", "77\\d{6}", "2(?:1[2-5]|7[45])\\d{5}", [8], option.None),
  ),
  #(
    "45",
    #(
  ...
  #(
    "502",
    #("Guatemala", "GT", "[3-5]\\d{7}", "[267][2-9]\\d{6}", [8], option.None),
  ),
  #(
    "1",
    #(
  ...
  #("683", #("Niue", "NU", "888[4-9]\\d{3}", "[47]\\d{3}", [4, 7], option.None)),
  #(
    "64",
    #(
      "New Zealand",
  ...
  #(
    "248",
    #("Seychelles", "SC", "2[125-8]\\d{5}", "4[2-46]\\d{5}", [7], option.None),
  ),
  #(
    "249",
    #(
  ...
  #(
    "268",
    #("Eswatini", "SZ", "7[6-9]\\d{6}", "[23][2-5]\\d{6}", [8], option.None),
  ),
  #(
    "1",
    #(
